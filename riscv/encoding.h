...
#define MATCH_DRCUPDATE 0x0000005b
#define MATCH_DALLOC 0x0200005b
#define MATCH_DREV 0x0400005b
#define MATCH_DCAPCREATE 0x0600005b
#define MATCH_DCAPTYPE 0x0800005b
#define MATCH_DCAPNODE 0x0a00005b
#define MATCH_DCAPPERM 0x0c00005b
#define MATCH_DCAPBOUND 0x0e00005b
#define MATCH_DCAPASYNC 0x1000005b
#define MATCH_DCAPREG 0x1200005b
#define MATCH_DCAPPRINT 0x1400005b
...
/*capstone instructions*/
// cap-man-insn
DECLARE_INSN(cs_revoke, MATCH_REVOKE, MASK_R_RI)
DECLARE_INSN(cs_shrink, MATCH_SHRINK, MASK_R_RI)
DECLARE_INSN(cs_tighten, MATCH_TIGHTEN, MASK_R_RI)
DECLARE_INSN(cs_delin, MATCH_DELIN, MASK_R_RI)
DECLARE_INSN(cs_lcc, MATCH_LCC, MASK_R_RI)
DECLARE_INSN(cs_scc, MATCH_SCC, MASK_R_RI)
DECLARE_INSN(cs_split, MATCH_SPLIT, MASK_R_RI)
DECLARE_INSN(cs_seal, MATCH_SEAL, MASK_R_RI)
DECLARE_INSN(cs_mrev, MATCH_MREV, MASK_R_RI)
DECLARE_INSN(cs_init, MATCH_INIT, MASK_R_RI)
DECLARE_INSN(cs_movc, MATCH_MOVC, MASK_R_RI)
DECLARE_INSN(cs_drop, MATCH_DROP, MASK_R_RI)
DECLARE_INSN(cs_cincoffset, MATCH_CINCOFFSET, MASK_R_RI)
DECLARE_INSN(cs_cincoffsetimm, MATCH_CINCOFFSETIMM, MASK_I_S)
// mem-access-insn
...
DECLARE_INSN(debug_capasync, MATCH_DCAPASYNC, MASK_R_RI)
DECLARE_INSN(debug_capreg, MATCH_DCAPREG, MASK_R_RI)
DECLARE_INSN(debug_capprint, MATCH_DCAPPRINT, MASK_R_RI)
