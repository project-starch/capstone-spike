...
// mask of instruction types
#define MASK_R_CI 0xfe00707f
#define MASK_I_S 0x707f
// R/CI type instructions
#define MATCH_REVOKE 0x0000105b
#define MATCH_SHRINK 0x0200105b
#define MATCH_TIGHTEN 0x0400105b
#define MATCH_DELIN 0x0600105b
#define MATCH_LCC 0x0800105b
#define MATCH_SCC 0x0a00105b
#define MATCH_SPLIT 0x0c00105b
#define MATCH_SEAL 0x0e00105b
#define MATCH_MREV 0x1000105b
#define MATCH_INIT 0x1200105b
#define MATCH_MOVC 0x1400105b
#define MATCH_DROP 0x1600105b
#define MATCH_CINCOFFSET 0x1800105b
#define MATCH_CALL 0x4000105b
#define MATCH_RETURN 0x4200105b
#define MATCH_CAPENTER 0x4400105b
#define MATCH_CAPEXIT 0x4600105b
// I/S type instructions
#define MATCH_CINCOFFSETIMM 0x0000205b
#define MATCH_LDC 0x0000305b
#define MATCH_STC 0x0000405b
#define MATCH_CJALR 0x0000505b
#define MATCH_CBNZ 0x0000605b
#define MATCH_CCSRRW 0x0000705b
// debug instructions (R type)
#define MATCH_DQUERY 0x0000005b
#define MATCH_DRCUPDATE 0x0200005b
#define MATCH_DALLOC 0x0400005b
#define MATCH_DREV 0x0600005b
#define MATCH_DCAPCREATE 0x0800005b
#define MATCH_DCAPTYPE 0x0a00005b
#define MATCH_DCAPNODE 0x0c00005b
#define MATCH_DCAPPERM 0x0e00005b
#define MATCH_DCAPBOUND 0x1000005b
#define MATCH_DPRINT 0x1200005b
...
/*capstone instructions*/
// cap-man-insn
// DECLARE_INSN(revoke, MATCH_REVOKE, MASK_R_CI)
// DECLARE_INSN(shrink, MATCH_SHRINK, MASK_R_CI)
// DECLARE_INSN(tighten, MATCH_TIGHTEN, MASK_R_CI)
// DECLARE_INSN(delin, MATCH_DELIN, MASK_R_CI)
// DECLARE_INSN(lcc, MATCH_LCC, MASK_R_CI)
// DECLARE_INSN(scc, MATCH_SCC, MASK_R_CI)
// DECLARE_INSN(split, MATCH_SPLIT, MASK_R_CI)
// DECLARE_INSN(seal, MATCH_SEAL, MASK_R_CI)
// DECLARE_INSN(mrev, MATCH_MREV, MASK_R_CI)
// DECLARE_INSN(init, MATCH_INIT, MASK_R_CI)
// DECLARE_INSN(movc, MATCH_MOVC, MASK_R_CI)
// DECLARE_INSN(drop, MATCH_DROP, MASK_R_CI)
// DECLARE_INSN(cincoffset, MATCH_CINCOFFSET, MASK_R_CI)
// DECLARE_INSN(cincoffsetimm, MATCH_CINCOFFSETIMM, MASK_DROP)
// mem-access-insn
// DECLARE_INSN(ldc, MATCH_LDC, MASK_I_S)
// DECLARE_INSN(stc, MATCH_STC, MASK_I_S)
// ctl-flow-insn
// DECLARE_INSN(call, MATCH_CALL, MASK_R_CI)
// DECLARE_INSN(ret, MATCH_RETURN, MASK_R_CI)
// DECLARE_INSN(cjalr, MATCH_CJALR, MASK_I_S)
// DECLARE_INSN(cbnz, MATCH_CBNZ, MASK_I_S)
// DECLARE_INSN(capenter, MATCH_CAPENTER, MASK_R_CI)
// DECLARE_INSN(capexit, MATCH_CAPEXIT, MASK_R_CI)
// ctrl-status-insn
// DECLARE_INSN(ccsrrw, MATCH_CCSRRW, MASK_I_S)
// debug instrucstions
// DECLARE_INSN(debug_query, MATCH_DQUERY, MASK_R_CI)
// DECLARE_INSN(debug_rcupdate, MATCH_DRCUPDATE, MASK_R_CI)
// DECLARE_INSN(debug_alloc, MATCH_DALLOC, MASK_R_CI)
// DECLARE_INSN(debug_rev, MATCH_DREV, MASK_R_CI)
// DECLARE_INSN(debug_capcreate, MATCH_DCAPCREATE, MASK_R_CI)
// DECLARE_INSN(debug_captype, MATCH_DCAPTYPE, MASK_R_CI)
// DECLARE_INSN(debug_capnode, MATCH_DCAPNODE, MASK_R_CI)
// DECLARE_INSN(debug_capperm, MATCH_DCAPPERM, MASK_R_CI)
// DECLARE_INSN(debug_capbound, MATCH_DCAPBOUND, MASK_R_CI)
// DECLARE_INSN(debug_print, MATCH_DPRINT, MASK_R_CI)
// DECLARE_INSN(debug_tagset, MATCH_DTAGSET, MASK_R_CI)
// DECLARE_INSN(debug_tagget, MATCH_DTAGGET, MASK_R_CI)
/*end of capstone instructions*/
#endif
#ifdef DECLARE_CSR
