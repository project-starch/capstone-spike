...
#define MATCH_LT 0x0a00105b
#define MASK_LT 0xfe00707f
...
#define MATCH_ADDINPLACE 0x1600105b
#define MASK_ADDINPLACE 0xfe00707f
...
#define MATCH_QUERY 0x0000005b
#define MASK_QUERY 0xfe00707f
#define MATCH_DROPT 0x0200005b
#define MASK_DROPT 0xfe00707f
#define MATCH_RCUPDATE 0x0400005b
#define MASK_RCUPDATE 0xfe00707f
#define MATCH_ALLOC 0x0600005b
#define MASK_ALLOC 0xfe00707f
#define MATCH_REVOKET 0x0800005b
#define MASK_REVOKET 0xfe00707f
#define MATCH_CAPCREATE 0x0a00005b
#define MASK_CAPCREATE 0xfe00707f
#define MATCH_CAPTYPE 0x0c00005b
#define MASK_CAPTYPE 0xfe00707f
#define MATCH_CAPNODE 0x0e00005b
#define MASK_CAPNODE 0xfe00707f
#define MATCH_CAPPERM 0x1000005b
#define MASK_CAPPERM 0xfe00707f
#define MATCH_CAPBOUND 0x1200005b
#define MASK_CAPBOUND 0xfe00707f
#define MATCH_PRINT 0x1400005b
#define MASK_PRINT 0xfe00707f
#define MATCH_TAGSET 0x1600005b
#define MASK_TAGSET 0xfe00707f
#define MATCH_TAGGET 0x1800005b
#define MASK_TAGGET 0xfe00707f
#define MATCH_SD 0x00002043
#define MASK_SD 0xfe00707f
...
DECLARE_INST(debug_print, MATCH_PRINT, MASK_PRINT)
DECLARE_INST(debug_alloc, MATCH_ALLOC, MASK_ALLOC)
DECLARE_INST(debug_rcupdate, MATCH_RCUPDATE, MASK_RCUPDATE)
DECLARE_INST(debug_revoke, MATCH_REVOKET, MASK_REVOKET)
DECLARE_INST(debug_drop, MATCH_DROPT, MASK_DROPT)
DECLARE_INST(debug_query, MATCH_QUERY, MASK_QUERY)
DECLARE_INSN(debug_capcreate, MATCH_CAPCREATE, MASK_CAPCREATE)
DECLARE_INSN(debug_captype, MATCH_CAPTYPE, MASK_CAPTYPE)
DECLARE_INSN(debug_capnode, MATCH_CAPNODE, MASK_CAPNODE)
DECLARE_INSN(debug_capperm, MATCH_CAPPERM, MASK_CAPPERM)
DECLARE_INSN(debug_capbound, MATCH_CAPBOUND, MASK_CAPBOUND)
#endif
#ifdef DECLARE_CSR
