...
// Encodings for TransCapstone
#define MATCH_CAPENTER  0x0000000b
...
#define MASK_JNZ 0xfe00707f
#define MATCH_SHRINK 0x0800105b
#define MASK_SHRINK 0xfe00707f
#define MATCH_TIGHTEN 0x0c00105b
#define MASK_TIGHTEN 0xfe00707f
#define MATCH_DELIN 0x0e00105b
#define MASK_DELIN 0xfe00707f
#define MATCH_SCC 0x1000105b
...
#define MATCH_STC 0x1e00105b
#define MASK_STC 0xfe00707f
...
#define MATCH_RETSEAL 0x2a00105b
#define MASK_RETSEAL 0xfe00707f
#define MATCH_LBS 0x2c00105b
#define MASK_LBS 0xfe00707f
#define MATCH_LDS 0x2e00105b
#define MASK_LDS 0xfe00707f
#define MATCH_LHS 0x3000105b
#define MASK_LHS 0xfe00707f
#define MATCH_LWS 0x3200105b
#define MASK_LWS 0xfe00707f
#define MATCH_SHS 0x3400105b
#define MASK_SHS 0xfe00707f
#define MATCH_SWS 0x3600105b
#define MASK_SWS 0xfe00707f
#define MATCH_SDS 0x3800105b
#define MASK_SDS 0xfe00707f
...
#define MASK_DEBUG_DROP 0xfe00707f
#define MATCH_DEBUG_RCUPDATE 0x0400005b
#define MASK_DEBUG_RCUPDATE 0xfe00707f
#define MATCH_DEBUG_ALLOC 0x0600005b
#define MASK_DEBUG_ALLOC 0xfe00707f
#define MATCH_DEBUG_REVOKE 0x0800005b
#define MASK_DEBUG_REVOKE 0xfe00707f
#define MATCH_DEBUG_CAPCREATE 0x0a00005b
#define MASK_DEBUG_CAPCREATE 0xfe00707f
#define MATCH_DEBUG_CAPTYPE 0x0c00005b
#define MASK_DEBUG_CAPTYPE 0xfe00707f
#define MATCH_DEBUG_CAPNODE 0x0e00005b
#define MASK_DEBUG_CAPNODE 0xfe00707f
#define MATCH_DEBUG_CAPPERM 0x1000005b
#define MASK_DEBUG_CAPPERM 0xfe00707f
#define MATCH_DEBUG_CAPBOUND 0x1200005b
#define MASK_DEBUG_CAPBOUND 0xfe00707f
#define MATCH_DEBUG_PRINT 0x1400005b
#define MASK_DEBUG_PRINT 0xfe00707f
#define MATCH_DEBUG_TAGSET 0x1600005b
#define MASK_DEBUG_TAGSET 0xfe00707f
#define MATCH_DEBUG_TAGGET 0x1800005b
#define MASK_DEBUG_TAGGET 0xfe00707f
#define MATCH_DEBUG_TOSECURE  0x0000100b
#define MASK_DEBUG_TOSECURE  0xffffffff
#define MATCH_DEBUG_TONORMAL  0x0010100b
#define MASK_DEBUG_TONORMAL  0xffffffff
...
DECLARE_INSN(capenter, MATCH_CAPENTER, MASK_CAPENTER)
DECLARE_INSN(capexit, MATCH_CAPEXIT, MASK_CAPEXIT)
DECLARE_INSN(capget, MATCH_CAPGET, MASK_CAPGET)
DECLARE_INSN(capret, MATCH_CAPRET, MASK_CAPRET)

DECLARE_INSN(mov, MATCH_MOV, MASK_MOV)
DECLARE_INSN(tighten, MATCH_TIGHTEN, MASK_TIGHTEN)
DECLARE_INSN(shrink, MATCH_SHRINK, MASK_SHRINK)
DECLARE_INSN(split, MATCH_SPLIT, MASK_SPLIT)
DECLARE_INSN(delin, MATCH_DELIN, MASK_DELIN)
DECLARE_INSN(scc, MATCH_SCC, MASK_SCC)
DECLARE_INSN(lcc, MATCH_LCC, MASK_LCC)
DECLARE_INSN(revoke, MATCH_REVOKE, MASK_REVOKE)
DECLARE_INSN(mrev, MATCH_MREV, MASK_MREV)
DECLARE_INSN(init, MATCH_INIT, MASK_INIT)
DECLARE_INSN(drop, MATCH_DROP, MASK_DROP)
DECLARE_INSN(jmp, MATCH_JMP, MASK_JMP)
DECLARE_INSN(jnz, MATCH_JNZ, MASK_JNZ)
DECLARE_INSN(ldc, MATCH_LDC, MASK_LDC)
DECLARE_INSN(stc, MATCH_STC, MASK_STC)
DECLARE_INSN(lds, MATCH_LDS, MASK_LDS)
DECLARE_INSN(lws, MATCH_LWS, MASK_LWS)
DECLARE_INSN(lhs, MATCH_LHS, MASK_LHS)
DECLARE_INSN(lbs, MATCH_LBS, MASK_LBS)
DECLARE_INSN(sds, MATCH_SDS, MASK_SDS)
DECLARE_INSN(sws, MATCH_SWS, MASK_SWS)
DECLARE_INSN(shs, MATCH_SHS, MASK_SHS)
DECLARE_INSN(sbs, MATCH_SBS, MASK_SBS)
DECLARE_INSN(seal, MATCH_SEAL, MASK_SEAL)
DECLARE_INSN(call, MATCH_CALL, MASK_CALL)
DECLARE_INSN(ret, MATCH_RETURN, MASK_RETURN)
DECLARE_INSN(retseal, MATCH_RETSEAL, MASK_RETSEAL)

DECLARE_INSN(debug_print, MATCH_DEBUG_PRINT, MASK_DEBUG_PRINT)
DECLARE_INSN(debug_alloc, MATCH_DEBUG_ALLOC, MASK_DEBUG_ALLOC)
DECLARE_INSN(debug_rcupdate, MATCH_DEBUG_RCUPDATE, MASK_DEBUG_RCUPDATE)
DECLARE_INSN(debug_revoke, MATCH_DEBUG_REVOKE, MASK_DEBUG_REVOKE)
DECLARE_INSN(debug_drop, MATCH_DEBUG_DROP, MASK_DEBUG_DROP)
DECLARE_INSN(debug_query, MATCH_DEBUG_QUERY, MASK_DEBUG_QUERY)
DECLARE_INSN(debug_capcreate, MATCH_DEBUG_CAPCREATE, MASK_DEBUG_CAPCREATE)
DECLARE_INSN(debug_captype, MATCH_DEBUG_CAPTYPE, MASK_DEBUG_CAPTYPE)
DECLARE_INSN(debug_capnode, MATCH_DEBUG_CAPNODE, MASK_DEBUG_CAPNODE)
DECLARE_INSN(debug_capperm, MATCH_DEBUG_CAPPERM, MASK_DEBUG_CAPPERM)
DECLARE_INSN(debug_capbound, MATCH_DEBUG_CAPBOUND, MASK_DEBUG_CAPBOUND)
DECLARE_INSN(debug_tagset, MATCH_DEBUG_TAGSET, MASK_DEBUG_TAGSET)
DECLARE_INSN(debug_tagget, MATCH_DEBUG_TAGGET, MASK_DEBUG_TAGGET)
DECLARE_INSN(debug_tosecure, MATCH_DEBUG_TOSECURE, MASK_DEBUG_TOSECURE)
DECLARE_INSN(debug_tonormal, MATCH_DEBUG_TONORMAL, MASK_DEBUG_TONORMAL)
#endif
#ifdef DECLARE_CSR
