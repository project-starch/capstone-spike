...
/*capstone instructions*/
// cap-man-insn
// DECLARE_INSN(revoke, MATCH_REVOKE, MASK_R_RI)
// DECLARE_INSN(shrink, MATCH_SHRINK, MASK_R_RI)
// DECLARE_INSN(tighten, MATCH_TIGHTEN, MASK_R_RI)
// DECLARE_INSN(delin, MATCH_DELIN, MASK_R_RI)
// DECLARE_INSN(lcc, MATCH_LCC, MASK_R_RI)
// DECLARE_INSN(scc, MATCH_SCC, MASK_R_RI)
// DECLARE_INSN(split, MATCH_SPLIT, MASK_R_RI)
// DECLARE_INSN(seal, MATCH_SEAL, MASK_R_RI)
// DECLARE_INSN(mrev, MATCH_MREV, MASK_R_RI)
// DECLARE_INSN(init, MATCH_INIT, MASK_R_RI)
// DECLARE_INSN(movc, MATCH_MOVC, MASK_R_RI)
// DECLARE_INSN(drop, MATCH_DROP, MASK_R_RI)
// DECLARE_INSN(cincoffset, MATCH_CINCOFFSET, MASK_R_RI)
...
// ctl-flow-insn
// DECLARE_INSN(call, MATCH_CALL, MASK_R_RI)
// DECLARE_INSN(ret, MATCH_RETURN, MASK_R_RI)
// DECLARE_INSN(cjalr, MATCH_CJALR, MASK_I_S)
// DECLARE_INSN(cbnz, MATCH_CBNZ, MASK_I_S)
// DECLARE_INSN(capenter, MATCH_CAPENTER, MASK_R_RI)
// DECLARE_INSN(capexit, MATCH_CAPEXIT, MASK_R_RI)
// ctrl-status-insn
...
// DECLARE_INSN(debug_alloc, MATCH_DALLOC, MASK_R_RI)
// DECLARE_INSN(debug_rev, MATCH_DREV, MASK_R_RI)
// DECLARE_INSN(debug_capcreate, MATCH_DCAPCREATE, MASK_R_RI)
// DECLARE_INSN(debug_captype, MATCH_DCAPTYPE, MASK_R_RI)
// DECLARE_INSN(debug_capnode, MATCH_DCAPNODE, MASK_R_RI)
// DECLARE_INSN(debug_capperm, MATCH_DCAPPERM, MASK_R_RI)
// DECLARE_INSN(debug_capbound, MATCH_DCAPBOUND, MASK_R_RI)
